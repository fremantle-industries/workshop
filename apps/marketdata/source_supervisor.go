...
import (
	...
	"github.com/fremantle-industries/workshop/apps/marketdata/source/tradier"
	"github.com/fremantle-industries/workshop/apps/marketdata/source/treasurydirect"
)
...
var (
	sources = map[string]gen.SupervisorChildSpec{
		...
		"tradier": {
			Child: tradier.NewSupervisor(),
			Name:  "tradierSupervisor",
		},
		"treasurydirect": {
			Child: treasurydirect.NewSupervisor(),
			Name:  "treasurydirectSupervisor",
		},
	}
)
